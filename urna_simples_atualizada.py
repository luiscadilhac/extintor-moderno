...
class UrnaEletronicaCIPA(App):
    ...
    def criar_botao_com_icone(self, texto, icone_path, cor, tamanho_icone=(20, 20)):
        ...
        # Botão
        btn = Button(text=texto, background_color=cor)
...
class TelaEmpresa(Screen):
    def __init__(self, **kwargs):
        ...
        form = GridLayout(cols=2, spacing=8, size_hint=(None, None), size=(700, 100), pos_hint={'center_x': 0.5, 'center_y': 0.65})
        form.add_widget(Label(text='Nome da Empresa:', color=(1, 0.6, 0.2, 1)))
        self.input_nome = TextInput(size_hint=(None, None), size=(450, 40))
        form.add_widget(self.input_nome)
        
        form.add_widget(Label(text='CNPJ:', color=(1, 0.6, 0.2, 1)))
        self.input_cnpj = TextInput(size_hint=(None, None), size=(450, 40))
        form.add_widget(self.input_cnpj)
        
        layout.add_widget(form)
        
        # Botões de ação
        btn_layout = BoxLayout(orientation='horizontal', spacing=15, size_hint=(None, None), size=(450, 50), pos_hint={'center_x': 0.5, 'center_y': 0.48})
        container_cadastrar, btn_cadastrar = app.criar_botao_com_icone('Cadastrar', 'icones/salvar.png', (0.7, 1, 0.7, 1), (30, 30))
        btn_cadastrar.size_hint = (None, None)
        btn_cadastrar.size = (80, 40)
        btn_cadastrar.bind(on_press=self.cadastrar_empresa)
        container_alterar, btn_alterar = app.criar_botao_com_icone('Alterar', 'icones/alterar.png', (1, 1, 0.7, 1), (30, 30))
        btn_alterar.size_hint = (None, None)
        btn_alterar.size = (80, 40)
        btn_alterar.bind(on_press=self.alterar_empresa)
        container_excluir, btn_excluir = app.criar_botao_com_icone('Excluir', 'icones/excluir.png', (1, 0.8, 0.8, 1), (30, 30))
        ...
        btn_inicio = Button(text='<<', size_hint=(None, None), size=(50, 40), background_color=(0.7, 0.9, 1, 1))
        btn_inicio.bind(on_press=self.ir_inicio)
        btn_anterior = Button(text='<', size_hint=(None, None), size=(50, 40), background_color=(0.7, 0.9, 1, 1))
        btn_anterior.bind(on_press=self.anterior)
        btn_proximo = Button(text='>', size_hint=(None, None), size=(50, 40), background_color=(0.7, 0.9, 1, 1))
        btn_proximo.bind(on_press=self.proximo)
        btn_fim = Button(text='>>', size_hint=(None, None), size=(50, 40), background_color=(0.7, 0.9, 1, 1))
        btn_fim.bind(on_press=self.ir_fim)
...
class TelaVotacao(Screen):
    def __init__(self, **kwargs):
        ...
        for i in range(1, 10):
            btn = Button(text=str(i), font_size='20sp', background_color=(0.1, 0.1, 0.1, 1), color=(1, 0.7, 0.4, 1))
            btn.bind(on_press=lambda x, num=str(i): self.digitar_numero(num))
            teclado.add_widget(btn)
        
        btn_corrige = Button(text='CORRIGE', font_size='12sp', background_color=(1, 0, 0, 1), color=(1,1,1,1))
        btn_corrige.bind(on_press=self.corrigir)
        
        btn_zero = Button(text='0', font_size='20sp', background_color=(0.1, 0.1, 0.1, 1), color=(1, 0.7, 0.4, 1))
        btn_zero.bind(on_press=lambda x: self.digitar_numero('0'))
        
        btn_confirma = Button(text='CONFIRMA', font_size='12sp', background_color=(0.133, 0.545, 0.133, 1), color=(1,1,1,1))
        ...
        btn_branco = Button(text='BRANCO', font_size='12sp', background_color=(1, 1, 1, 1), background_normal='', color=(0,0,0,1))
