...
class BotaoComIcone(Button):
    def __init__(self, texto, icone_path, **kwargs):
        super().__init__(**kwargs)
        
        # Layout horizontal para ícone + texto
        layout = BoxLayout(orientation='horizontal', spacing=5, padding=[5, 0])
        
        # Ícone
        if os.path.exists(icone_path):
            icone = Image(source=icone_path, size_hint=(None, None), size=(20, 20))
            layout.add_widget(icone)
        
        # Texto
        label = Label(text=texto, font_size='12sp', color=(0, 0, 0, 1), halign='left', valign='middle')
...
class TelaInicial(Screen):
    def __init__(self, **kwargs):
        ...
        btn_empresa = BotaoComIcone('EMPRESA\nGerenciar', 'icones/empresa.png', size_hint=(1, 0.6), background_color=(0.7, 1, 0.7, 1))
        btn_empresa.bind(on_press=self.ir_empresa)
        
        btn_mesario = BotaoComIcone('MESARIO\nAdministrar', 'icones/mesario.png', size_hint=(1, 0.6), background_color=(1, 0.9, 0.6, 1))
        btn_mesario.bind(on_press=self.ir_mesario)
        
        btn_inscricoes = BotaoComIcone('INSCRICOES\nCandidatos', 'icones/inscricoes.png', size_hint=(1, 0.6), background_color=(0.7, 0.9, 1, 1))
        btn_inscricoes.bind(on_press=self.ir_inscricoes)
        
        btn_votacao = BotaoComIcone('VOTACAO\nEleitor', 'icones/votacao.png', size_hint=(1, 0.6), background_color=(1, 0.8, 1, 1))
...
class TelaEmpresa(Screen):
    def __init__(self, **kwargs):
        ...
        btn_voltar = BotaoComIcone('<< Voltar', 'icones/voltar.png', size_hint_x=0.15, size_hint_y=0.6, background_color=(1, 0.8, 0.8, 1))
        ...
        btn_cadastrar = BotaoComIcone('Cadastrar', 'icones/salvar.png', background_color=(0.7, 1, 0.7, 1))
        btn_cadastrar.bind(on_press=self.cadastrar_empresa)
        btn_listar = BotaoComIcone('Listar', 'icones/listar.png', background_color=(0.7, 0.9, 1, 1))
        btn_listar.bind(on_press=self.listar_empresas)
        btn_excluir = BotaoComIcone('Excluir', 'icones/excluir.png', background_color=(1, 0.8, 0.8, 1))
...
class TelaInscricoes(Screen):
    def __init__(self, **kwargs):
        ...
        btn_inscrever = BotaoComIcone('Inscrever Candidato', 'icones/confirmar.png', size_hint_y=0.08, background_color=(0.7, 1, 0.7, 1))
...
class TelaCodigoEmpresa(Screen):
    def __init__(self, **kwargs):
        ...
        btn_confirmar = BotaoComIcone('CONFIRMAR', 'icones/confirmar.png', background_color=(0.7, 1, 0.7, 1))
        btn_confirmar.bind(on_press=self.confirmar_codigo)
        
        btn_voltar = BotaoComIcone('VOLTAR', 'icones/voltar.png', background_color=(1, 0.8, 0.8, 1))
        btn_voltar.bind(on_press=self.voltar)
...
class TelaVotacao(Screen):
    def __init__(self, **kwargs):
        ...
        btn_voltar = BotaoComIcone('<< Voltar', 'icones/voltar.png', size_hint_y=0.1, background_color=(1, 0.8, 0.8, 1))
        btn_voltar.bind(on_press=self.voltar)
