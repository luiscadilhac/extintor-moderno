...
class TelaInicial(Screen):
    def __init__(self, **kwargs):
        ...
        titulo = Label(text='URNA ELETRONICA CIPA', font_size='28sp', bold=True, size_hint_y=0.3, color=(1, 0.6, 0.2, 1))
        layout.add_widget(titulo)
        
        menu = GridLayout(cols=2, spacing=15, size_hint_y=0.7)
        
        btn_empresa = Button(text='🏢 EMPRESA\nGerenciar', font_size='12sp', size_hint=(1, 0.6), background_color=(0.7, 1, 0.7, 1))
        btn_empresa.bind(on_press=self.ir_empresa)
        
        btn_mesario = Button(text='👨‍💼 MESARIO\nAdministrar', font_size='12sp', size_hint=(1, 0.6), background_color=(1, 0.9, 0.6, 1))
        btn_mesario.bind(on_press=self.ir_mesario)
        
        btn_inscricoes = Button(text='📝 INSCRICOES\nCandidatos', font_size='12sp', size_hint=(1, 0.6), background_color=(0.7, 0.9, 1, 1))
        btn_inscricoes.bind(on_press=self.ir_inscricoes)
        
        btn_votacao = Button(text='🗳️ VOTACAO\nEleitor', font_size='12sp', size_hint=(1, 0.6), background_color=(1, 0.8, 1, 1))
...
class TelaEmpresa(Screen):
    def __init__(self, **kwargs):
        ...
        btn_voltar = Button(text='⬅️ Voltar', size_hint_x=0.15, size_hint_y=0.6, background_color=(1, 0.8, 0.8, 1))
        ...
        btn_excluir = Button(text='🗑️ Excluir', background_color=(1, 0.8, 0.8, 1))
...
class TelaCodigoEmpresa(Screen):
    def __init__(self, **kwargs):
        ...
        btn_voltar = Button(text='⬅️ VOLTAR', font_size='18sp', background_color=(1, 0.8, 0.8, 1))
        btn_voltar.bind(on_press=self.voltar)
...
class TelaVotacao(Screen):
    def __init__(self, **kwargs):
        ...
        btn_voltar = Button(text='⬅️ Voltar', size_hint_y=0.1, background_color=(1, 0.8, 0.8, 1))
        btn_voltar.bind(on_press=self.voltar)
