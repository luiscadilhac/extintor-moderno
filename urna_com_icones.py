...
def criar_botao_com_icone(texto, icone_path, cor):
    ...
    if os.path.exists(icone_path):
        icone = Image(source=icone_path, size_hint_y=0.6)
        layout.add_widget(icone)
    
    label = Label(text=texto, font_size='10sp', size_hint_y=0.4, color=(0, 0, 0, 1))
...
def criar_botao_pequeno(texto, icone_path, cor):
    ...
    label = Label(text=texto, font_size='10sp', size_hint_x=0.7, color=(0, 0, 0, 1))
    layout.add_widget(label)
