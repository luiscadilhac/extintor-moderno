...
class TelaInicial(Screen):
    def __init__(self, **kwargs):
        ...
        # Botões simples com texto
        btn_empresa = Button(text='[size=16][b]EMPRESA[/b][/size]\nGerenciar', markup=True, font_size='12sp', size_hint=(1, 0.6), background_color=(0.7, 1, 0.7, 1))
        btn_empresa.bind(on_press=self.ir_empresa)
        
        btn_mesario = Button(text='[size=16][b]MESARIO[/b][/size]\nAdministrar', markup=True, font_size='12sp', size_hint=(1, 0.6), background_color=(1, 0.9, 0.6, 1))
        btn_mesario.bind(on_press=self.ir_mesario)
        
        btn_inscricoes = Button(text='[size=16][b]INSCRICOES[/b][/size]\nCandidatos', markup=True, font_size='12sp', size_hint=(1, 0.6), background_color=(0.7, 0.9, 1, 1))
        btn_inscricoes.bind(on_press=self.ir_inscricoes)
        
        btn_votacao = Button(text='[size=16][b]VOTACAO[/b][/size]\nEleitor', markup=True, font_size='12sp', size_hint=(1, 0.6), background_color=(1, 0.8, 1, 1))
...
class TelaEmpresa(Screen):
    def __init__(self, **kwargs):
        ...
        btn_voltar = Button(text='<< Voltar', size_hint_x=0.15, size_hint_y=0.6, background_color=(1, 0.8, 0.8, 1))
        ...
        btn_cadastrar = Button(text='Cadastrar', background_color=(0.7, 1, 0.7, 1))
        btn_cadastrar.bind(on_press=self.cadastrar_empresa)
        btn_listar = Button(text='Listar', background_color=(0.7, 0.9, 1, 1))
        btn_listar.bind(on_press=self.listar_empresas)
        btn_excluir = Button(text='Excluir', background_color=(1, 0.8, 0.8, 1))
...
class TelaInscricoes(Screen):
    def __init__(self, **kwargs):
        ...
        btn_inscrever = Button(text='Inscrever Candidato', size_hint_y=0.08, background_color=(0.7, 1, 0.7, 1))
...
class TelaCodigoEmpresa(Screen):
    def __init__(self, **kwargs):
        ...
        btn_confirmar = Button(text='CONFIRMAR', font_size='18sp', background_color=(0.7, 1, 0.7, 1))
        btn_confirmar.bind(on_press=self.confirmar_codigo)
        
        btn_voltar = Button(text='VOLTAR', font_size='18sp', background_color=(1, 0.8, 0.8, 1))
        btn_voltar.bind(on_press=self.voltar)
...
class TelaVotacao(Screen):
    def __init__(self, **kwargs):
        ...
        btn_voltar = Button(text='<< Voltar', size_hint_y=0.1, background_color=(1, 0.8, 0.8, 1))
        btn_voltar.bind(on_press=self.voltar)
