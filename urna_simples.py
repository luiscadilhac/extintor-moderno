...
class TelaAuth(Screen):
    ...
    def mostrar_popup(self, titulo, mensagem):
        ...
        label = Label(text=mensagem, text_size=(600, None), halign='center', valign='middle', font_size='22sp', color=(0, 0, 0, 1))
        btn_ok = Button(text='OK', size_hint_y=None, height=60, font_size='18sp', color=(0.5, 0.8, 1, 1))
        content.add_widget(label)
        content.add_widget(btn_ok)
        popup = Popup(title=titulo, content=content, size_hint=(0.95, 0.7), title_size='24sp')
        btn_ok.bind(on_press=popup.dismiss)
        popup.open()
...
class TelaEmpresa(Screen):
    ...
    def nova_empresa(self, instance):
        ...
        # Não alterar o índice para permitir novo cadastro
        # self.indice_atual permanece onde está
    ...
    def mostrar_popup_codigo(self, titulo, mensagem, codigo):
        ...
        label = Label(text=mensagem, text_size=(500, None), halign='center', valign='middle', font_size='20sp', color=(0, 0, 0, 1))
        codigo_input = TextInput(text=codigo, readonly=True, multiline=False, size_hint_y=None, height=50, font_size='18sp')
        btn_ok = Button(text='OK', size_hint_y=None, height=50, font_size='16sp', color=(0.5, 0.8, 1, 1))
        content.add_widget(label)
        content.add_widget(codigo_input)
        content.add_widget(btn_ok)
        popup = Popup(title=titulo, content=content, size_hint=(0.9, 0.7), title_size='22sp')
        btn_ok.bind(on_press=popup.dismiss)
        popup.open()
...
class TelaMesario(Screen):
    ...
    def mostrar_popup(self, titulo, mensagem):
        ...
        content.add_widget(label)
        content.add_widget(btn_ok)
        popup = Popup(title=titulo, content=content, size_hint=(0.95, 0.8), title_size='24sp')
        btn_ok.bind(on_press=popup.dismiss)
        popup.open()
...
class TelaInscricoes(Screen):
    def __init__(self, **kwargs):
        ...
        form = GridLayout(cols=2, spacing=8, size_hint=(None, None), size=(1200, 120), pos_hint={'center_x': 0.5})
        
        form.add_widget(Label(text='Nome:', color=(1, 0.6, 0.2, 1)))
        self.input_nome = TextInput(size_hint=(None, None), size=(900, 40), font_size='14sp')
        form.add_widget(self.input_nome)
        
        form.add_widget(Label(text='CPF:', color=(1, 0.6, 0.2, 1)))
        self.input_cpf = TextInput(size_hint=(None, None), size=(900, 40), font_size='14sp')
        form.add_widget(self.input_cpf)
        
        form.add_widget(Label(text='Codigo da Empresa:', color=(1, 0.6, 0.2, 1)))
        self.input_empresa = TextInput(size_hint=(None, None), size=(900, 40), font_size='14sp')
